...
function buildRunManifestSummary(outputDirRelative, reviewLog) {
  ...
  return {
    ...
    recoverableAcceptedCount: reviewLog.summary.recoverableAcceptedCount ?? 0,
    usableWinnerLowConfidenceCount: reviewLog.summary.usableWinnerLowConfidenceCount ?? 0,
    recoveredValidRejectCount: reviewLog.summary.recoveredValidRejectCount ?? 0,
    remainingRecoverableWinnerRejectCount: reviewLog.summary.remainingRecoverableWinnerRejectCount ?? 0,
    duplicateBlockedRejectCount: reviewLog.summary.duplicateBlockedRejectCount ?? 0,
    factBlockedRejectCount: reviewLog.summary.factBlockedRejectCount ?? 0,
    factReviewSuggestedCount: reviewLog.summary.factReviewSuggestedCount ?? 0,
    auxiliaryOnlyMismatchCount: reviewLog.summary.auxiliaryOnlyMismatchCount ?? 0,
    metadataRepairedCount: reviewLog.summary.metadataRepairedCount ?? 0,
    metadataRepairedByTier: reviewLog.summary.metadataRepairedByTier ?? {},
    visualAuditRequiredCount: reviewLog.summary.visualAuditRequiredCount ?? 0,
    chapterFallbackRecoveredCount: reviewLog.summary.chapterFallbackRecoveredCount ?? 0,
    unresolvedMetadataRejectCount: reviewLog.summary.unresolvedMetadataRejectCount ?? 0,
    trueNoGroundingRejectCount: reviewLog.summary.trueNoGroundingRejectCount ?? 0,
