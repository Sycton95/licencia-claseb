...
export function AiQueueManager({
  ...
  return (
    <section className="admin-manager admin-manager--ai">
      <div
        className={
          isDetailOpen
        ...
        <section className="admin-manager__master-surface">
          <div className="admin-manager__master-head">
            <div className="admin-manager__summary">
              <span className="eyebrow">Cola AI</span>
              <h3 className="section-title">Sugerencias editoriales</h3>
              <p className="info-text">
                {filteredSuggestions.length} sugerencia(s) visibles para triage editorial.
              </p>
            </div>
          ...
          {!selectedSuggestion ? (
            <div className="admin-ai-placeholder">
              ...
              <p className="admin-ai-placeholder__copy">
                Selecciona una sugerencia para revisar su grounding, rationale y decisión editorial.
              </p>
            ...
            <section className="panel admin-surface admin-pane admin-pane--detail">
              ...
              <div className="admin-detail-list admin-detail-list--summary">
                ...
                <div className="admin-detail-list__row">
                  <span>Capítulo</span>
                  <strong>{selectedSuggestion.chapterId || 'sin capítulo'}</strong>
                </div>
              </div>
              ...
              <div className="admin-pane__body admin-detail-stack">
                <label className="field field--full">
                  ...
                  <textarea rows={6} value={selectedSuggestion.prompt} readOnly />
                </label>
                <label className="field field--full">
                  <span>Grounding</span>
                  <textarea rows={10} value={selectedSuggestion.groundingExcerpt} readOnly />
                </label>
                <label className="field field--full">
                  <span>Rationale</span>
                  <textarea rows={8} value={selectedSuggestion.rationale} readOnly />
                </label>
