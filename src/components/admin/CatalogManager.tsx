  ...
  return (
    <div className="relative flex h-full w-full flex-1 overflow-hidden">
      <div
        ...
        `}
      >
        <div className="z-10 shrink-0 space-y-3 border-b border-neutral-200 bg-neutral-50/80 p-3">
        ...
        <div className="flex-1 space-y-1.5 overflow-y-auto bg-neutral-50/30 p-2.5">
          ...
          {questions.length === 0 && (
            <AdminEmptyState
              ...
              message="No hay preguntas para esta búsqueda. Ajusta el filtro o intenta con otro ID."
            />
          )}
        </div>
      </div>
      ...
      <div
        className={`
          relative flex h-full min-w-0 flex-1 flex-col bg-neutral-50
