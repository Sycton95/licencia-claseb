  ...
  for (const item of items) {
    ...
    const question: Question = {
      ...
      importMetadata: {
        ...
        sourceBuildId: sandboxProvenance?.sourceBuildId,
        runId: sandboxProvenance?.runId,
        ...
        visualDependency: sandboxProvenance?.visualDependency,
        verifierScore: sandboxProvenance?.verifierScore,
        verifierIssues: sandboxProvenance?.verifierIssues,
        duplicateClusterId: item.duplicateReview?.clusterId,
        duplicateSuggestedWinnerId: item.duplicateReview?.suggestedWinnerId,
        duplicateDecisionMode: item.duplicateReview?.decisionMode,
        duplicateSimilarityToSuggested: item.duplicateReview?.similarityToSuggested,
        duplicateReviewerSummary: item.duplicateReview?.reviewerSummary,
